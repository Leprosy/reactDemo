...
ReactDOM.render([<NoteListComponent title="List of my notes" />, <StaticTestComponent title="Static content with properties" />, <DynamicTestComponent />], document.getElementById("rootContent"));
